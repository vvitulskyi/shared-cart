...
import { loginValidator, registrationValidator, } from "../validations/account.js";
...
class Account {
    constructor() {
        ...
        this.router = Router();
        // Login
        this.router.post("/account/login", loginValidator, handleValidationErrors, async (req, res) => {
            try {
        ...
        // Registration
        this.router.post("/account/registration", registrationValidator, handleValidationErrors, async (req, res) => {
            try {
